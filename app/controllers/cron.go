...
func init() {
	...
	http.Handle("/cron-list", misc.Chain(true, false, func(w http.ResponseWriter, r *http.Request) {
		entries := []*cron.Entry{}
	...
	http.Handle("/cron-results", misc.Chain(true, false, func(w http.ResponseWriter, r *http.Request) {
